...
- ``_result_from_response`` parses valid JSON chapter payloads into
  ``ChapterMarkersResult`` and raises ``ChapterMarkersResponseFormatError``
  for malformed, missing-key, or incorrectly typed JSON responses.
