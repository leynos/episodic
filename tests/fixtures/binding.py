...
class _SnapshotTestFixtures:
    """Bundle the domain objects used by source-document snapshot tests."""
...
def uow_with_fixtures(
    ...
    """Provide the legacy fixture name used by existing binding tests."""
    return uow_with_binding_fixtures


@pytest.fixture
def binding_test_uow(
    uow_with_binding_fixtures: BindingFixtures,
) -> CanonicalUnitOfWork:
