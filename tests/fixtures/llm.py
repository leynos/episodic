...
def openai_adapter_factory() -> _OpenAIAdapterFactory:
    ...
    async def _build_adapter(  # noqa: PLR0913  # Many parameters needed to mirror OpenAICompatibleLLMConfig overrides for test parametrization; see https://github.com/leynos/episodic/pull/49
        *,
