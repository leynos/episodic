"""Unit and property tests for chapter-marker generation."""
...
def test_build_prompt_includes_tei_and_segment_structure() -> None:
    ...
    assert "segment_structure" in prompt
    assert "seg-intro" in prompt
    assert "PT5M30S" in prompt
...
def test_enrich_tei_with_chapter_markers() -> None:
