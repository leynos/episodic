...
- PR `#99` resolved the Celery integration gap called out in
  `Surprises & discoveries` for issue `#66`: CPU-bound Celery tasks now have
  documented task-level guidance and tests showing how to call
