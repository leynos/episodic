...
def source_document_from_attachment(
    ...
    ----------
    projection
        Deterministic source-document projection input containing the intake
        attachment, optional resolved upload, target episode, identifier, and
        creation timestamp.

    Returns
    -------
    SourceDocument
        Canonical source-document metadata ready for repository persistence.
    """
