"""Provider-cost recording for completed generation graphs."""
...
async def _record_action_costs_from_results(
    ...
    *,
    ...
    """Record cost entries for action results that carry provider usage."""
...
async def _record_costs_from_finished_state(
    ...
    *,
    ...
    """Record provider costs from a completed direct graph path."""
